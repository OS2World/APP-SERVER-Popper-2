...
extern void __setkey_r __P ((__const char *__key, struct crypt_data *__data));
extern void setkey_r __P ((__const char *__key, struct crypt_data *__data));

extern void __encrypt_r __P ((char *__block, int __edflag,
			      struct crypt_data *__data));
